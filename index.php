            ...
            <section class="banner_main">
               <div class="container-fluid">
                  <div class="row d_flex">
                     <div class="col-md-5">
                        <div class="text-bg">
                           <h1>Software<br>And<br>Hardware<br>Limited</h1>
      ...
      <div id="about" class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>About Labbitech Limited</h2>
                     <span>Labbitech Limited is an IT Company that deals with export and import of computer peripherals and also in Software development and Hardware maintenance. 
                     </span>
                  </div>
               </div>
            </div>
      ...
      <div id="" class="best">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>Avialable Extra Services Include </h2>
                     <span>POS SERVICES,DATA BONDLES,TV CABLES SUBCRIPTIONS ETC.</span>
                  </div>
               </div>
            </div>
            <div class="row">
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     ...
                     <span>You can contact us by filling in the following form with the requeid information.</span>
                  </div>
               </div>
            </div>
            <div class="row">
      ...
      <div  class="two_box">
         <div class="container-fluid">
            <div class="row d_flex">
               ...
               <div class="col-md-6">
                  <div class="two_box_img">
                     <h2><span class="offer">15%</span>0ffer blackfriday</h2>
                     <p>We offer 15% discount every end of the month friday to all our costomers thank you for your serviceses </p>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="footer">
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>© 2021 All Rights Reserved. Design by <a href="https://html.design/"> Labbitech Limited</a></p>
                     </div>
                  </div>
               </div>
            </div>
